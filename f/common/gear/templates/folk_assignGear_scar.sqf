...
_bagmedium = "ACE_Rucksack_MOLLE_Brown";																								// Backpack for assistant gunners (AAR, AMMG, AMAT, AHAT), so that they don't have to drop ammo themselves
_baglarge =  "ACE_Rucksack_MOLLE_Brown"; 		
...
_HMGammo = "ACE_M2_CSWDM";																											// Assistant Heavy MG (note: HMG is an assembled weapon, assistant carries bipod/tripd)
...
_MTRmount = "ACE_M224TripodProxy";	
_MTRammoHE = "ACE_M252HE_CSWDM";
_MTRammoWP = "ACE_M252WP_CSWDM";
_MTRammoIL = "ACE_M252IL_CSWDM";																												// Mortar Assistant Gunner (note: Mortar is an assembled weapon, assistant carries bipod/tripd)
